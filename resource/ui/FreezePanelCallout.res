"Resource/UI/FreezePanelCallout.res" //bind ctrl "toggle host_timescale 0.01 1"
{
	"CalloutBG"
	{
		...
		"scaleImage"		"1"	
		"teambg_2"		"../hud/color_panel_blu#custom_offset_alt"//"../hud/color_panel_blu"	// Reversed, due to showing killer's name
		"teambg_3"		"../hud/color_panel_red#custom_offset_alt"//"../hud/color_panel_red"	// Reversed, due to showing killer's name
