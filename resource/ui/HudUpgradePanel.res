...
{	
	...
	"SelectWeaponPanel"
	{
		...
		"MouseOverTabPanel"
		{
			...
			"enabled"		"1"
			"tabPosition"		"0"
			"bgcolor_override"	"col_hl1_orghl_o"//"239 128 73 255"
			"PaintBackgroundType"	"0"//"2"
		}
		
		"MouseOverUpgradePanel" //hover effect behind UpgradeBuyPanel.res
		{
			"ControlName"	"EditablePanel"
		...
		"UpgradeItemsDescriptionLabel" //detailed description of selected/hovered upgrade
		{
			"ControlName"	"CExLabel"
			"fieldName"		"UpgradeItemsDescriptionLabel"
			"font"			"fntGenSmalledium"//"fntGenMedium"//"ItemFontAttribLarge"
		...
		"UpgradeItemsLabel"
		{
			...
			"font"			"fntGenSmalledium"//"HudFontSmall"
		...
		"UpgradeItemStatsLabel" //active item/upgrade stats
		{
			"ControlName"	"CExLabel"
			"fieldName"		"UpgradeItemStatsLabel"
			"font"			"fntGenSmalledium"//"ItemFontAttribSmall"
			"labelText"		""
		...
		"CreditsLabel" //credits num val
		{
			"ControlName"	"CExLabel"
			"fieldName"		"CreditsLabel"
			"font"			"fntGenLarge"//"HudFontMediumSmall"
			"labelText"		"%credits%"
			"textAlignment"	"east"
			"xpos"			"0"
			"ypos"			"280"
		...
		"CancelButton" //"Cancel"
		{
			...
			"font"			"fntGenMiddish"//"HudFontSmallestBold"
			"textAlignment"	"center"
			"textinsetx"	"50"
			"dulltext"		"0"
			"brighttext"	"0"
